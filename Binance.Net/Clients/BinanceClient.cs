...
namespace Binance.Net.Clients
{
    ...
    public class BinanceClient : BaseRestClient, IBinanceClient
    {
        ...
        internal Task<WebCallResult<T>> SendRequestInternal<T>(RestApiClient apiClient, Uri uri, HttpMethod method,
            ...
            where T : class
        {
            return base.SendRequestAsync<T>(apiClient, uri, method, cancellationToken, parameters, signed, postPosition,
                arraySerialization, weight, ignoreRatelimit: ignoreRateLimit);
        }
