...
public class TestHelpers
{
    ...
    public static IBinanceSocketClient CreateSocketClient(IWebsocket socket, BinanceSocketClientOptions options = null)
    {
        ...
        Mock.Get(client.SocketFactory).Setup(f => f.CreateWebsocket(It.IsAny<Log>(), It.IsAny<string>()))
            .Returns(socket);
        return client;
    }
    ...
    {
        BinanceClient client = (BinanceClient)CreateClient(options);
