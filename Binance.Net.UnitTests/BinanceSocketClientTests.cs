...
public class BinanceNetTest
{
    ...
    {
        // arrange
        TestSocket socket = new();
        IBinanceSocketClient client = TestHelpers.CreateSocketClient(socket);
        ...
        BinanceCombinedStream<BinanceStreamKlineData> data = new()
        {
    ...
    public async Task SubscribingToSymbolTicker_Should_TriggerWhenSymbolTickerStreamMessageIsReceived()
    {
        ...
        IBinanceSocketClient client =
            TestHelpers.CreateSocketClient(socket, new BinanceSocketClientOptions { LogLevel = LogLevel.Debug });

        IBinanceTick result = null;
        await client.SpotStreams.SubscribeToTickerUpdatesAsync("ETHBTC", test => result = test.Data);

        BinanceCombinedStream<BinanceStreamTick> data = new()
        {
    ...
    public async Task SubscribingToTradeStream_Should_TriggerWhenTradeStreamMessageIsReceived()
    {
        ...
        BinanceCombinedStream<BinanceStreamTrade> data = new()
        {
            Stream = "ethbtc@trade",
    ...
    public async Task SubscribingToUserStream_Should_TriggerWhenAccountUpdateStreamMessageIsReceived()
    {
        ...
        BinanceCombinedStream<BinanceStreamBalanceUpdate> data = new()
        {
            Stream = "test",
    ...
    public void SubscribingToUserStream_Should_TriggerWhenOcoOrderUpdateStreamMessageIsReceived()
    {
        ...
        BinanceCombinedStream<BinanceStreamOrderList> data = new()
        {
            Stream = "test",
            Data = new BinanceStreamOrderList
            {
                ...
                Orders = new[]
                {
                    new BinanceStreamOrderId { Symbol = "BNBUSDT", OrderId = 2, ClientOrderId = "3" },
                    new BinanceStreamOrderId { Symbol = "BNBUSDT", OrderId = 3, ClientOrderId = "4" }
                }
            }
        };
    ...
    public void SubscribingToUserStream_Should_TriggerWhenOrderUpdateStreamMessageIsReceived()
    {
        ...
        BinanceCombinedStream<BinanceStreamOrderUpdate> data = new()
        {
            Stream = "test",
